...
class FunctCall_Relocation:
    ...
    def __init__(self,path,src_file):
        self.path = path
...
if __name__ == '__main__':
    ...
    path = '/Users/waynec/Desktop/EPLab/Eco-build-Keilc/eco-dev/test_page_reload_seg/tools'
    ...
    funct = FunctCall_Relocation(path,src_file)
